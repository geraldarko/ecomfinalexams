      ...
      <div class="container h-100">
        ...
        <div class="container tm-mt-big tm-mb-big">
          <div class="row">
            <div class="d-flex justify-content-center">
              <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                <div class="row">
                  <div class="col-12">
                    <h2 class="tm-block-title d-inline-block">Add Style</h2>
                  </div>
                </div>
                <div class="row tm-edit-product-row">
                  ...
                  <div class="col-6">
                    <button type="submit" name="submit" class="btn btn-primary btn-block text-uppercase">Add Style</button>
                  </div>
                </form>
                </div>
              </div>
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-product-categories">
            <center><h2 class="tm-block-title">Plan Styles</h2></center>
