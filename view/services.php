  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="../images/user/services/ext2.png" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
                  <img loading="lazy" src="../images/user/icon-image/service-icon4.png" alt="service-icon">
              </div>
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="service-single.html">EXTERIOR DESIGN</a></h3>
                  <p>Darkus Architecture Services provides the best exterior design which encompasses both physical structures as well as personal and artistic designs such as paint color, roof shape and material, decks, patios, gardens, and more</p>
              </div>
            </div>
        </div><!-- Service1 end -->
      </div><!-- Col 4 end -->
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="../images/user/services/interior.jpg" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
              ...
              <div class="ts-service-info">
                  ...
                  <p>Darkus Architecture enhances the interior of a building to achieve a healthier and more aesthetically pleasing environment for clients using the space.</p>
              </div>
            </div>
        </div><!-- Service2 end -->
      </div><!-- Col 5 end -->
      ...
      <div class="col-lg-4 col-md-6 mb-5">
        <div class="ts-service-box">
            <div class="ts-service-image-wrapper">
              <img loading="lazy" class="w-100" src="../images/user/services/cm.jpg" alt="service-image">
            </div>
            <div class="d-flex">
              <div class="ts-service-box-img">
                  <img loading="lazy" src="../images/user/icon-image/service-icon6.png" alt="service-icon">
              </div>
              <div class="ts-service-info">
                  <h3 class="service-box-title"><a href="service-single.html">Construction Management</a></h3>
                  <p>Involved in planning, designing, constucting, operating, maintain and supervising and renovating building structures which includs homes,malls,hospitals and many more</p>
              </div>
            </div>
        </div><!-- Service3 end -->
      </div><!-- Col 6 end -->
