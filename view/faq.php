        ...
        <div class="accordion accordion-group accordion-classic" id="construction-accordion">
          <div class="card">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
              ...
              <div class="card-body">
                Darkus Architectural Service is a company that deals with building plans, interior and exterior plans. Building plans sold could also be customized. 
              </div>
            </div>
          </div>
          <div class="card">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
              data-parent="#construction-accordion">
              <div class="card-body">
                We have building plans ranging from modern to contemporary designs. Checkout from our <a href="plan.html">Plan</a> page to buy plans. We also allow users to customize their plans.
              </div>
            </div>
          </div>
        </div>
