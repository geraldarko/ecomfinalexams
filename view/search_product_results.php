              ...
              <div class="product-item">
                <div class="product-thumb">
                  ...
                  <div class="preview-meta">
                    <ul>
                      <li>
                      <a href="single_product.php?id=<?php echo $product_one['plan_id']; ?>"><i class="tf-ion-ios-eye"></i></a>
                      </li>
                      <li>
                      <a href="../actions/add_to_cart.php?id=<?php echo $product_one['plan_id']; ?>"><i class="tf-ion-android-cart"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
