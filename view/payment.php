          ...
          <div class="col-md-8 col-md-offset-4">
            <div class="block">
              <div class="product-list">
                <form method="post">
                  <table class="table">
                    <h4>Confirm Order and Proceed To Payments</h4>
                    <thead>
                      <tr>
                      ...
                      <tr class="">
                        <td class="">
                          <div class="product-info">
                            <img width="80" src="../images/user/projects/project1.jpeg" alt="" height="100" />
                            <a href="#!">Offices</a>
                          </div>
                        </td>
                        <td class="">$200.00</td>
                  ...
                  <a href="#" class="btn btn-main pull-right">Pay Here</a>
                </form>
              </div>
            </div>
          </div>
